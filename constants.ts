export const GAME_CONSTANTS = {
  GRAVITY: 0.8,
  JUMP_FORCE: -14,
  GROUND_Y_OFFSET: 100, // Distance from bottom
  SCROLL_SPEED_BASE: 6,
...
export const HEART_PATTERNS = [
  { type: 'single', hearts: [{ y: 0 }] },                    // Ground level
  { type: 'double', hearts: [{ y: 0 }, { y: 0, x: 120 }] },    // Two in row
  { type: 'high_low', hearts: [{ y: -60 }, { y: 0 }] },        // Air + ground
  { type: 'triple', hearts: [{ y: 0 }, { y: 0, x: 100 }, { y: 0, x: 200 }] },
  { type: 'floating', hearts: [{ y: -50 }] },                 // Requires jump
  // New patterns for more jumps
...
// Reduced gaps for constant action
...
export const JULES_MESSAGES = [
  ...
  "i love u mi <3 babi!",
  "keep going babi!",
  "my heart is yours babi!",
  "forever us babi <3",
  "running with u is fun babi!",
  "babi you're the best!",
  "together forever babi!",
  "yay hearts babi!",
  "so proud of u babi!",
  "jumping for joy babi!",
  "we got this babi!",
  "look at us go babi!",
  "<3 <3 <3 babi!",
  "pure happiness babi!",
